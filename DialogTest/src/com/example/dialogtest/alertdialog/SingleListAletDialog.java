...
public class SingleListAletDialog extends DialogFragment
{
    public static SingleListAletDialog newInstance()
    {
        return new SingleListAletDialog();
    }

    private SingleListAletDialog()
    {
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        // list与msg互斥AlertController中setupContent方法可证明
